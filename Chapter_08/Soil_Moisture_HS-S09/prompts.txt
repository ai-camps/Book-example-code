...
•	Reads the digital value (HIGH or LOW) from SW-520D every 3 second.
•	Beep the Piezo Buzzer and change LED color to indicate if tilt is detected.


Requirements:
•	Use PlatformIO as your IDE.
•	Connect ESP32 GPIO pin 0 to the D0 pin of HS-S09.
...
•	If the value is LOW, that indicates moisture is detected, beep the Piezo Buzzer, and change the LED color to red.
•	If the value is HIGH, that indicates no moisture is detected, mute the Piezo Buzzer, and maintain the LED color to green.
