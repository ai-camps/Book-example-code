...
•	Reads the digital value (HIGH or LOW) from KY-026 every 3 second.
•	Beep the Piezo Buzzer and change LED color to indicate flame is detected.

Requirements:
•	Use PlatformIO as your IDE.
•	Connect ESP32 GPIO pin 0 to KY-026 D0 pin.
...
•	If the value is HIGH, that indicates flame is detected, beep the Piezo Buzzer, and change the LED color to red.
•	If the value is LOW, that indicates no flame is detected, mute the Piezo Buzzer, and maintain the LED color to green.
