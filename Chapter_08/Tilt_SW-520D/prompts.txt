...
•	Connect ESP32 GPIO pin 0 to the D0 pin of SW-520D.
...
•	If the value is HIGH, that indicates tilt is detected, beep the Piezo Buzzer, and change the LED color to red.
•	If the value is LOW, that indicates no tilt is detected, mute the Piezo Buzzer, and maintain the LED color to green.
