...
•	Reads the digital value (HIGH or LOW) from HC-SR501 every 3 second.
•	Beep the Piezo Buzzer and change LED color to indicate motion is detected.

Requirements:
•	Use PlatformIO as your IDE.
•	Connect ESP32 GPIO pin 0 to HC-SR501 signal out pin.
...
•	If the value is HIGH, that indicates a motion is detected, beep the Piezo Buzzer, and change the LED color to red.
•	If the value is LOW, that indicates no motion is detected, mute the Piezo Buzzer, and maintain the LED color to green.
